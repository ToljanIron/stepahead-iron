/*globals angular , $ ,  window , notStickyVariance, notStickyClass, $document, document, prevOffset , calcOffsetToTop, calcOffsetToBottom, isNotSticky, calculateTopOffset, initialTop, currentTranslateY, $element, _ , unused */
angular.module('ng-sticky', []).directive('stickyFloatContainer', function ($window) {
  'use strict';
  return {
