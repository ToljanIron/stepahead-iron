module CdsPinsHelper
  def self.create_pin(pin_name, pin_definition)
    criteria = transform_to_wherepart pin_definition
    Pin.create(pin_name, criteria)
  end

  def self.transform_to_wherepart(conds)
  ...
  def self.add_status_to_new_pin(action_button)
  ...
  def self.create_condition_list(conditions)
